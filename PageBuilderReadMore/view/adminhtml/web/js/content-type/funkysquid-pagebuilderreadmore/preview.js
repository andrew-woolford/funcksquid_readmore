define([
     ...
     * @param element
     */
    Preview.prototype.getOrderClass = function getOrderClass(element) {
        let attributesObject = element.attributes();
        return attributesObject['buttons'] ? 'action '+attributesObject['buttons'] : '';
    }
